...
the \texttt{struct vfsmount} data structure has several fields including:
...
\texttt{char *} & \texttt{mnt\_devname} & Device filename.\\
\texttt{struct list\_head} & \texttt{mnt\_child} & \\
