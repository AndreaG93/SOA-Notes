...
By definition, \textbf{coherence defines what values can be returned by a read} while \textbf{consistency determines when a written value will be returned by a read}.
